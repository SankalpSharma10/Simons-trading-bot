...
if 'symbol' not in st.session_state: st.session_state.symbol = 'BTC/USDT'
...
with st.sidebar:
    ...
    # --- 3. ASSET SELECTION MENU (XRP REMOVED) ---
    with st.expander("🪙 ASSET SELECTION", expanded=False):
        wl = ["BTC/USDT", "ETH/USDT", "SOL/USDT"] 
        for s in wl:
